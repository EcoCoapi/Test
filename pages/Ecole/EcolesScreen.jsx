...
export default function EcolesScreen({navigation}) {
    ...
    const loadData = () => {
        ...
        newList.push(<Ecole key={1} navigation={navigation} name={"Ecole 1"}/>)
        newList.push(<Ecole key={2} navigation={navigation} name={"Ecole 2"}/>)
        newList.push(<Ecole key={3} navigation={navigation} name={"Ecole 3"}/>)
