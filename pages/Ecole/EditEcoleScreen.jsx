...
export default function EditEcole ({navigation}) {

    const {currentEcole} = useContext(GlobalStateContext)
    ...
    const handleEditEcole = () => {
        //Fonction pour modifier une école dans la BDD
        navigation.goBack()
    }
    const handleDeleteEcole = () => {
        //Fonction pour supprimer une école dans la BDD
        navigation.goBack()
    }

    return (
        <View>
            <NavBar navigation={navigation} screenName={'Edit-Ecole Screen'}/>
            <View style={styles.container}>
                <Text style={styles.text}>Modification d'un profile école</Text>
                <TextInput style={styles.textInput} placeholder="Nom" value={currentEcole}/>
                ...
                <Button onPress={handleEditEcole} title="Modifier le profile école"/>
                <Button onPress={handleDeleteEcole} title="Supprimer le profile école"/>
