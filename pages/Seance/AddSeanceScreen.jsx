...
export default function AddSeanceScreen ({navigation}) {
    ...
    return (
        <View>
            ...
            <View style={styles.container}>
                <Text style={styles.text}>Ajouter une séance</Text>
                ...
                <Button title="Ajouter la séance" onPress={handleAddSeance}/>
