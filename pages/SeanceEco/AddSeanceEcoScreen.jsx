...
export default function AddSeanceEcoScreen ({navigation}) {
    ...
    return (
        <View>
            <NavBar navigation={navigation} screenName={"Add-Seance Eco Screen"}/>
            <View style={styles.container}>
                <Text style={styles.text}>Ajouter une séance ECO</Text>
                {!dateVisible ? <TextInput editable style={styles.textInput} placeholder={"Nom"}/> : null}
                ...
                <Button title="Ajouter la séance" onPress={handleAddSeanceEco}/>
